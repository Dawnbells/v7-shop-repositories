...
export const asyncRoutes: VabRouteRecord[] = [
  {
    ...
    children: [
      ...
      {
        path: 'cloakRiskControl',
        name: 'CloakRiskControl',
        component: () => import('/@/views/index/cloakRiskControl.vue'),
        meta: {
          title: '斗篷风控',
          icon: 'shield-line',
          guard: ['Admin'],
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'emailConfigCenter',
        name: 'EmailConfigCenter',
        component: () => import('/@/views/system/EmailConfigCenter.vue'),
        meta: {
          title: '邮件配置',
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'themeBuilder',
        name: 'ThemeBuilder',
        component: () => import('/@/views/product/ThemeBuilder.vue'),
        meta: {
          title: '主题编辑器',
          icon: 'brush-line',
          hidden: true,
