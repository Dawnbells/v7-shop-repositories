<template>
  <div class="currency-container auto-height-container">
    <vab-query-form>
    ...
    <el-table ref="tableRef" v-loading="listLoading" border :data="list" @selection-change="setSelectRows">
      ...
      <el-table-column align="center" label="货币名称" prop="name" />
      <el-table-column align="center" label="货币符号" prop="symbol" />
      <el-table-column align="center" label="货币代码" prop="code">
        <template #header>
          <el-space wrap>
            <text>货币代码</text>
            <el-tooltip class="box-item" content="使用ISO-4217标准" effect="dark" placement="top">
              <vab-icon icon="question-line" />
            </el-tooltip>
          </el-space>
        </template>
      </el-table-column>
      <el-table-column align="center" label="有效小数位" prop="fractionDigits" />
      <el-table-column align="center" label="货币汇率" prop="exchangeRate">
        <template #header>
          <el-space wrap>
            <text>货币汇率</text>
            <el-tooltip class="box-item" content="该货币兑基准货币汇率" effect="dark" placement="top">
              <vab-icon icon="question-line" />
            </el-tooltip>
          </el-space>
        </template>
    ...
    />
    <currency-edit ref="editRef" @fetch-data="fetchData" />
  </div>
</template>

<script lang="ts" setup>
import { Delete, Plus, Search } from '@element-plus/icons-vue'
import { doDelete, page, switchValidity } from '/@/api/currency'
