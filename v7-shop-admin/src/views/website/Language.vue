<template>
  <div class="language-container auto-height-container">
    ...
    <el-table ref="tableRef" v-loading="listLoading" border :data="list" @selection-change="setSelectRows">
      ...
      <el-table-column align="center" label="语言名称" prop="name" />
      <el-table-column align="center" label="中文名称" prop="cname" />
      <el-table-column align="center" label="语言代码" prop="code" />
    ...
    />
    <language-edit ref="editRef" @fetch-data="fetchData" />
  </div>
</template>

<script lang="ts" setup>
import { Delete, Plus, Search } from '@element-plus/icons-vue'
import { doDelete, page, switchValidity } from '/@/api/language'
