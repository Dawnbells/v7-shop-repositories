<template>
  <div class="third-website-container auto-height-container">
    <vab-query-form>
    ...
    />
    <third-party-website-edit ref="editRef" @fetch-data="fetchData" />
    <third-party-order-sync ref="orderSyncRef" />
  </div>
</template>

<script lang="ts" setup>
import { Delete, Plus, Search } from '@element-plus/icons-vue'
import { doDelete, page, switchValidity } from '../../api/ThirdPartyWebsite'
...
const orderSyncRef = ref<any>(null)
...
const handleOrderSync = (row = {}) => {
  console.log(row)
  orderSyncRef.value.showEdit(row)
}
