<template>
  <div class="domain-container auto-height-container">
    <vab-query-form>
    ...
    >
      ...
      <el-table-column align="center" label="名称" prop="fullName" />
    ...
    />
    <domain-edit ref="editRef" @fetch-data="fetchData" />
  </div>
</template>

<script lang="ts" setup>
import { Delete, Plus, Search } from '@element-plus/icons-vue'
import { doDelete, page } from '/@/api/domain'
