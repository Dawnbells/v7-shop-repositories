<template>
  <div class="server-manager-container auto-height-container">
    <vab-query-form>
    ...
    />
    <server-manager-edit ref="editRef" @fetch-data="fetchData" />
  </div>
</template>

<script lang="ts" setup>
import { Delete, Plus, Search } from '@element-plus/icons-vue'
import { doDelete, page, switchValidity } from '/@/api/serverManager'
