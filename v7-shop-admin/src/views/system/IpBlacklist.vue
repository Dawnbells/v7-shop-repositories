<template>
  <div class="ip-blacklist-container auto-height-container">
    <vab-query-form>
    ...
    >
      ...
      <el-table-column align="center" label="IP" prop="ipAddress" />
      <el-table-column align="center" label="浏览器指纹" prop="fingerprint" />
    ...
    />
    <ip-blacklist-edit ref="editRef" @fetch-data="fetchData" />
  </div>
</template>

<script lang="ts" setup>
import { Delete, Plus, Search } from '@element-plus/icons-vue'
import { doDelete, page, switchValidity } from '/@/api/ipBlacklist'
