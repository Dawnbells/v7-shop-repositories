<template>
  <div class="cloud-platform-account-container auto-height-container">
    <vab-query-form>
    ...
    <el-table ref="tableRef" v-loading="listLoading" border :data="list" @selection-change="setSelectRows">
      ...
      <el-table-column align="center" label="AccessKey" prop="accessKey" />
      <el-table-column align="center" label="Secret" prop="accessKeySecret" />
      <el-table-column align="center" label="Endpoint" prop="endpoint" />
      <el-table-column align="center" label="云平台" prop="cloudPlatform">
        <template #default="{ row }">
          <el-tag type="primary">{{ row.cloudPlatform }}</el-tag>
        </template>
      </el-table-column>
    ...
    />
    <cloud-platform-account-edit ref="editRef" @fetch-data="fetchData" />
  </div>
</template>

<script lang="ts" setup>
import { Delete, Plus, Search } from '@element-plus/icons-vue'
import { doDelete, page, switchValidity } from '/@/api/cloudPlatformAccount'

defineOptions({
  name: 'CloudPlatformAccount',
})
