<template>
  <div class="sku-container auto-height-container">
    <vab-query-form>
      ...
      <vab-query-form-left-panel v-if="!isVirtual" :span="24">
    ...
    >
      ...
      <el-table-column align="center" label="编码" prop="skuCode" />
      <el-table-column align="center" label="品名" prop="name" />
      <el-table-column align="center" label="销量" prop="totalUnitsSold" />
      <el-table-column align="center" label="销售额" prop="totalSalesRevenue" />
