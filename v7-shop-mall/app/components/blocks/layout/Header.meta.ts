...
export const meta: ComponentMeta = {
  ...
  propsSchema: [
    {
      ...
      defaultValue: 'left',
      options: [
        { label: 'Logo 靠左', value: 'left' },
        { label: 'Logo 居中', value: 'center' },
      ],
  ...
  styleSchema: [
    ...
    { key: 'borderBottomWidth', label: '底部边框宽度', type: 'text', placeholder: '1px', group: 'border' },
    { key: 'borderBottomStyle', label: '底部边框样式', type: 'select', options: [
      { label: '无', value: 'none' },
      { label: '实线', value: 'solid' },
      { label: '虚线', value: 'dashed' },
      { label: '点线', value: 'dotted' },
    ], group: 'border' },
    { key: 'borderBottomColor', label: '底部边框颜色', type: 'color', group: 'border' },
    { key: 'boxShadow', label: '阴影', type: 'text', placeholder: '0 2px 8px rgba(0,0,0,0.1)', group: 'shadow' },
    { key: 'paddingLeft', label: '左内边距', type: 'text', placeholder: '16px', group: 'padding' },
    { key: 'paddingRight', label: '右内边距', type: 'text', placeholder: '16px', group: 'padding' },
  ],
